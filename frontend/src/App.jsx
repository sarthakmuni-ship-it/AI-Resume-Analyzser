...
function App() {
  ...
  const handleDeleteHistory = async (id, e) => {
    e.stopPropagation(); // Prevents the card from opening when you click the trash can
    
    const confirmDelete = window.confirm("Are you sure you want to delete this scan? This cannot be undone.");
  ...
  const startComparison = () => {
    const sorted = [...compareList].sort((a, b) => new Date(a.created_at) - new Date(b.created_at));
